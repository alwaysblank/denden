 ...
 * @param channel The name of the channel(s) to dispatch to. Will create fully qualified routes if they do not already exist.
 ...
 * // "received: reuben"
 */
export function watch<Payload>(hub: Hub, channel: ChannelRoute|ChannelRoute[], target: EventTarget, eventType: string, processor?: WatchProcessor<Payload>) {
